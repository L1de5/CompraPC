...
class EditarForm(Form):
    ...
    senha = PasswordField('Senha', validators=[Length(min = 3, max = 80)])
    conf_senha = PasswordField('Confirmar Senha', validators=[Length(min = 3, max = 80)])
    endereco = StringField('Endereço', validators=[Length(min = 3, max = 240)])
